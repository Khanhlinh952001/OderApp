      ...
      <View style={{flex:1}}>
        <ScrollView style={{flex:1}}>

               {
                data.map((item)=>{
                  return(
                    <TouchableOpacity key={item.id} style={{height:105,borderRadius:10,backgroundColor:'white',flexDirection:'row',marginBottom:5,marginTop:5,justifyContent:'space-between'}}>
                      ...
                      <View>
                        <TouchableOpacity onPress={()=>Chuyen(item)} style={{height:80,width:80,margin:10,backgroundColor:'green',borderRadius:30,alignItems:'center'}}>
